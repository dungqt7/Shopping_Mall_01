        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    {!! Form::text('name', $value = $category['cate_name'] , $attribute = ['class' => 'form-control col-md-7 col-xs-12', "placeholder" =>'Vui lòng nhập tên danh mục']) !!}  
                    {!!$errors->first('name')!!}
                </div>
            </div>
            <div class="form-group">
                {!! Form::label('txtparent', 'Loại danh mục cha', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12' )) !!}
            </label>
            <center>
         ...
         {!! Form::label('txtparent', 'Trạng Thái', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12' )) !!}
        <div class="col-md-6 col-sm-6 col-xs-12">
            {{ Form::checkbox('status', '1', $category['status']== 1 ? 'checked' : '') }}
        </div>
        <div class="form-group">
            {!! Form::submit('Update', array('class' => 'btn btn-primary add', 'id' => 'add')) !!}   
        </div>
        {!!Form::close()!!}
    </div>
</div>
