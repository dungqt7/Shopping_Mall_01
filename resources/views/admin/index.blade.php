...
<html lang="en">
  <head>
    ...
    <title>{{ trans('backend.admin')}}</title>
    <link href="{!!url('public/bower_components/bootstrap/dist/css/bootstrap.min.css')!!}" rel="stylesheet">
    <link href="{!!url('public/bower_components/font-awesome/css/font-awesome.min.css')!!}" rel="stylesheet">
    <link href="{!!url('public/css/custom.min.css')!!}" rel="stylesheet">
    <link href="{!!url('public/admin/jquery-ui/jquery-ui.css')!!}" rel="stylesheet">
    <link href="{!!url('public/css/style1.css')!!}" rel="stylesheet">
    <script src="{!!url('public/admin/tinymce/tinymce.min.js')!!}"></script>
    <script src="{!!url('public/admin/tinymce/plugins/advlist/plugin.min.js')!!}"></script>
    <script>
      var baseURL ="{!!url('/')!!}";
    </script>
  </head>
  <body class="nav-md">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-paint-brush" aria-hidden="true"></i>{{ trans('backend.color')}}<span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a><i class="fa fa-truck"></i> {{ trans('backend.factories') }}<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="chartjs2.html">{{ trans('backend.add_factories') }}</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-star"></i> {{ trans('backend.rates') }} <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li><a><i class="fa fa-credit-card-alt"></i>{{ trans('backend.payments') }}  <span class="fa fa-chevron-down"></span></a>
                   ...
                   <li><a><i class="fa fa-phone" aria-hidden="true"></i> {{ trans('backend.contacts') }}<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="{!!url('public/admin/images/img.jpg')!!}" alt="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="{!!url('authentication/logout')!!}"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
              </ul>
            </nav>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <iframe src="http://localhost/Shopping_Mall_02/filemanager/dialog.php?field_id=image" style="border:none; width:100%; height: 500px" ></iframe>
          </div>
    ...
    <script src="{!!url('public/bower_components/bootstrap/dist/js/bootstrap.min.js')!!}"></script>
     <script src="{!!url('public/admin/jquery-ui/jquery-ui.js')!!}"></script>
    <script src="{!!url('public/admin/js/main.js')!!}"></script>
    <script src="{!!url('public/admin/js/logo.js')!!}"></script>
    <script src="{!!url('public/admin/build/js/custom.min.js')!!}"></script>
    <script src="{!!url('public/admin/js/edit.js')!!}"></script>
    <script src="{!!url('public/admin/js/list.js')!!}"></script>
    <script src="{!!url('public/admin/js/flash.js')!!}"></script>
    <script src="{!!url('public/admin/js/color.js')!!}"></script>
    <script src="{!!url('public/admin/js/editcolor.js')!!}"></script>
    <script src="{!!url('public/admin/js/size.js')!!}"></script>
    <script src="{!!url('public/admin/js/editsize.js')!!}"></script>
 </body>
</html>
