...
<html lang="en">
  <head>
    ...
    <link href="{!!url('public/admin/build/css/mystyle.css')!!}" rel="stylesheet">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-paint-brush" aria-hidden="true"></i> Color <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ action('ColorController@index') }}">List Color</a></li>
                      <li><a href="{{ action('ColorController@create') }}">Add Color</a></li>
                    </ul>
                  </li>
                   <li><a><i class="fa fa-truck"></i> Size <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ action('SizeController@index') }}">List size</a></li>
