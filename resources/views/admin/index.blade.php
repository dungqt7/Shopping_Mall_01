...
<head>
  ...
  <link href="{!!asset('bower_components/admin/css/mystyle.css')!!}" rel="stylesheet">
  <link href="{!!asset('admin/build/css/custom.min.css')!!}" rel="stylesheet">
  <link href="{!!asset('admin/jquery-ui/jquery-ui.css')!!}" rel="stylesheet">
  <script src="{!!asset('admin/js/ckeditor/ckeditor.js')!!}"></script>
  <script src="{!!asset('admin/tinymce/tinymce.min.js')!!}"></script>
  <script src="{!!asset('tinymce/plugins/advlist/plugin.min.js')!!}"></script>
  <script>
    var baseURL ="{!!url('/')!!}";
  </script>
...
<script src="{!!asset('bower_components/gauge.js/dist/gauge.min.js')!!}"></script>
<script src="{!!asset('admin/jquery-ui/jquery-ui.js')!!}"></script>
...
<script src="{!!asset('admin/js/color.js')!!}"></script>
<script src="{!!asset('admin/js/editcolor.js')!!}"></script>
<script src="{!!asset('admin/js/size.js')!!}"></script>
<script src="{!!asset('admin/js/editsize.js')!!}"></script>
</body>
</html>
