  ...
  <tbody>
    ...
    <tr>
     ...
     <td>
      ...
      {{ Form::button('View', array('class' => 'btn btn btn-success listcolor fa fa-list ', 'data-id' => $value->id)) }}
      {{ Form::button('Edit', array('class' => 'btn btn btn-primary xoacolor fa fa-pencil ', 'data-id' => $value->id)) }}
