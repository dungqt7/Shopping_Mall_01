    ...
    <div class="container" style="margin-top:20px">
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          {!!Form::open(array('route'=>array('category-list.destroy',$data['id']),'method'=>'PUT'))!!}
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="txtToan" value="{!!old('txtToan',isset($data)?$data['mathspoint']:null)!!}" />
            </div>
            <div class="form-group">
              <label for="lblLy">Điểm Môn Lý</label>
              <input type="text" class="form-control" name="txtLy" value="{!!old('txtLy',isset($data)?$data['physicpoint']:null)!!}" />
            </div>
            <div class="form-group">
              <label for="lblHoa">Điểm Môn Hóa</label>
              <input type="text" class="form-control" name="txtHoa" value="{!!old('txtHoa',isset($data)?$data['chemistrypoint']:null)!!}" />
            </div>
